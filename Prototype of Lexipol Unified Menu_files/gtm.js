...
d,0))/h,1))*(1-Math.min((Math.max(0-e.top,0)+Math.max(e.bottom-c,0))/f,1)):0};var mj=new RegExp(/[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}/i),nj=["SCRIPT","IMG","SVG","PATH"];function oj(a){var b;if(a===H.body)b="body";else{var c;if(a.id)c="#"+a.id;else{var d;if(a.parentElement){var e;a:{var f=a.parentElement;if(f){for(var h=0;h<f.childElementCount;h++)if(f.children[h]===a){e=h+1;break a}e=-1}else e=1}d=oj(a.parentElement)+">:nth-child("+e+")"}else d="";c=d}b=c}return b}
...
f++}}return 0};var Jl=!!F.MutationObserver,Kl=void 0,Ll=function(a){if(!Kl){var b=function(){var c=H.body;if(c)if(Jl)(new MutationObserver(function(){for(var e=0;e<Kl.length;e++)I(Kl[e])})).observe(c,{childList:!0,subtree:!0});else{var d=!1;Yc(c,"DOMNodeInserted",function(){d||(d=!0,I(function(){d=!1;for(var e=0;e<Kl.length;e++)I(Kl[e])}))})}};Kl=[];H.body?b():I(b)}Kl.push(a)};
var Wl=function(a,b,c){function d(){var h=a();f+=e?(La()-e)*h.playbackRate/1E3:0;e=La()}var e=0,f=0;return{fc:function(h,k,l){var n=a(),p=n.Ke,r=void 0!==l?Math.round(l):void 0!==k?Math.round(n.Ke*k):Math.round(n.Mg),t=void 0!==k?Math.round(100*k):0>=p?0:Math.round(r/p*100),q=H.hidden?!1:.5<=fj(c);d();var u=zl(c,"gtm.video",[b]);u["gtm.videoProvider"]="youtube";u["gtm.videoStatus"]=h;u["gtm.videoUrl"]=n.url;u["gtm.videoTitle"]=n.title;u["gtm.videoDuration"]=Math.round(p);u["gtm.videoCurrentTime"]=
Math.round(r);u["gtm.videoElapsedTime"]=Math.round(f);u["gtm.videoPercent"]=t;u["gtm.videoVisible"]=q;pl(u)},Lh:function(){e=La()},Vc:function(){d()}}};var Xl=F.clearTimeout,Yl=F.setTimeout,N=function(a,b,c){if(qg()){b&&I(b)}else return Uc(a,b,c)},Zl=function(){return new Date},$l=function(){return F.location.href},am=function(a){return Be(De(a),"fragment")},bm=function(a){return Ce(De(a))},cm=function(a,b){return me(a,b||2)},dm=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=pl(a)):d=pl(a);return d},em=function(a,b){F[a]=b},X=function(a,b,c){b&&
...
Z.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(x){for(var A=[],z=x.split(","),B=0;B<z.length;B++){var E=Number(z[B]);if(isNaN(E))return[];p.test(z[B])||A.push(E)}return A}function c(){var x=0,A=0;return function(){var z=ej(),B=z.height;x=Math.max(v.scrollLeft+z.width,x);A=Math.max(v.scrollTop+B,A);return{Og:x,Pg:A}}}function d(){q=X("self");
u=q.document;v=u.scrollingElement||u.body&&u.body.parentNode;y=c()}function e(x,A,z,B){var E=l(A),G={},M;for(M in E){G.Ka=M;if(E.hasOwnProperty(G.Ka)){var O=Number(G.Ka);x<O||(dm({event:"gtm.scrollDepth","gtm.scrollThreshold":O,"gtm.scrollUnits":z.toLowerCase(),"gtm.scrollDirection":B,"gtm.triggers":E[G.Ka].join(",")}),Cl("sdl",A,function(V){return function(W){delete W[V.Ka];return W}}(G),{}))}G={Ka:G.Ka}}}function f(){var x=y(),A=x.Og,z=x.Pg,B=A/v.scrollWidth*100,E=z/v.scrollHeight*100;e(A,"horiz.pix",
r.Wb,t.qe);e(B,"horiz.pct",r.Vb,t.qe);e(z,"vert.pix",r.Wb,t.De);e(E,"vert.pct",r.Vb,t.De);Bl("sdl","pending",!1)}function h(){var x=250,A=!1;u.scrollingElement&&u.documentElement&&q.addEventListener&&(x=50,A=!0);var z=0,B=!1,E=function(){B?z=Yl(E,x):(z=0,f(),im("sdl")&&!a()&&(Zc(q,"scroll",G),Zc(q,"resize",G),Bl("sdl","init",!1)));B=!1},G=function(){A&&y();z?B=!0:(z=Yl(E,x),Bl("sdl","pending",!0))};return G}function k(x,A,z){if(A){var B=b(String(x));Cl("sdl",z,function(E){for(var G=0;G<B.length;G++){var M=
String(B[G]);E.hasOwnProperty(M)||(E[M]=[]);E[M].push(A)}return E},{})}}function l(x){return Dl("sdl",x,{})}function n(x){I(x.vtp_gtmOnSuccess);var A=x.vtp_uniqueTriggerId,z=x.vtp_horizontalThresholdsPixels,B=x.vtp_horizontalThresholdsPercent,E=x.vtp_verticalThresholdUnits,G=x.vtp_verticalThresholdsPixels,M=x.vtp_verticalThresholdsPercent;switch(x.vtp_horizontalThresholdUnits){case r.Wb:k(z,A,"horiz.pix");break;case r.Vb:k(B,A,"horiz.pct")}switch(E){case r.Wb:k(G,A,"vert.pix");break;case r.Vb:k(M,
A,"vert.pct")}im("sdl")?Dl("sdl","pending")||(w||(d(),w=!0),I(function(){return f()})):(d(),w=!0,v&&(jm("sdl"),Bl("sdl","pending",!0),I(function(){f();if(a()){var O=h();Yc(q,"scroll",O);Yc(q,"resize",O)}else Bl("sdl","init",!1)})))}var p=/^\s*$/,r={Vb:"PERCENT",Wb:"PIXELS"},t={De:"vertical",qe:"horizontal"},q,u,v,w=!1,y;(function(x){Z.__sdl=x;Z.__sdl.b="sdl";Z.__sdl.g=!0;Z.__sdl.priorityOverride=0})(function(x){x.vtp_triggerStartOption?n(x):Ik(function(){n(x)})})}();
...
Z.a.ytl=["google"],function(){function a(){var v=Math.round(1E9*Math.random())+"";return H.getElementById(v)?a():v}function b(v,w){if(!v)return!1;for(var y=0;y<r.length;y++)if(0<=v.indexOf("//"+r[y]+"/"+w))return!0;return!1}function c(v){var w=-1!==v.indexOf("?")?"&":"?";if(-1<v.indexOf("origin="))return v+w+"enablejsapi=1";if(!q){var y=X("document");q=y.location.protocol+"//"+y.location.hostname;y.location.port&&(q+=":"+y.location.port)}return v+w+"enablejsapi=1&origin="+encodeURIComponent(q)}function d(v,
w){var y=v.getAttribute("src");if(b(y,"embed/")){if(0<y.indexOf("enablejsapi=1"))return!0;if(w)return v.setAttribute("src",c(y)),!0}return!1}function e(v,w){if(!v.getAttribute("data-gtm-yt-inspected-"+w.Dd)&&(v.setAttribute("data-gtm-yt-inspected-"+w.Dd,"true"),d(v,w.Oe))){v.id||(v.id=a());var y=X("YT"),x=y.get(v.id);x||(x=new y.Player(v.id));var A=h(x,w),z={},B;for(B in A)z.Wa=B,A.hasOwnProperty(z.Wa)&&x.addEventListener(z.Wa,function(E){return function(G){return A[E.Wa](G.data)}}(z)),z={Wa:z.Wa}}}
function f(v){I(function(){function w(){for(var x=y.getElementsByTagName("iframe"),A=x.length,z=0;z<A;z++)e(x[z],v)}var y=X("document");w();Ll(w)})}function h(v,w){var y,x;function A(){ca=Wl(function(){return{url:P,title:U,Ke:K,Mg:v.getCurrentTime(),playbackRate:T}},w.Dd,v.getIframe());K=0;U=P="";T=1;return z}function z(S){switch(S){case t.PLAYING:K=Math.round(v.getDuration());P=v.getVideoUrl();if(v.getVideoData){var ma=v.getVideoData();U=ma?ma.title:""}T=v.getPlaybackRate();w.Gg?ca.fc("start"):ca.Vc();
J=n(w.Dh,w.Ch,v.getDuration());return B(S);default:return z}}function B(){oa=v.getCurrentTime();R=Zl().getTime();ca.Lh();W();return E}function E(S){var ma;switch(S){case t.ENDED:return M(S);case t.PAUSED:ma="pause";case t.BUFFERING:var Za=v.getCurrentTime()-oa;ma=1<Math.abs((Zl().getTime()-R)/1E3*T-Za)?"seek":ma||"buffering";v.getCurrentTime()&&(w.Fg?ca.fc(ma):ca.Vc());V();return G;case t.UNSTARTED:return A(S);default:return E}}function G(S){switch(S){case t.ENDED:return M(S);case t.PLAYING:return B(S);
case t.UNSTARTED:return A(S);default:return G}}function M(){for(;x;){var S=y;Xl(x);S()}w.Eg&&ca.fc("complete",1);return A(t.UNSTARTED)}function O(){}function V(){x&&(Xl(x),x=0,y=O)}function W(){if(J.length&&0!==T){var S=-1,ma;do{ma=J[0];if(ma.Ha>v.getDuration())return;S=(ma.Ha-v.getCurrentTime())/T;if(0>S&&(J.shift(),0===J.length))return}while(0>S);y=function(){x=0;y=O;0<J.length&&J[0].Ha===ma.Ha&&(J.shift(),ca.fc("progress",ma.Ve,ma.Ze));W()};x=Yl(y,1E3*S)}}var ca,J=[],K,P,U,T,oa,R,ha=A(t.UNSTARTED);
x=0;y=O;return{onStateChange:function(S){ha=ha(S)},onPlaybackRateChange:function(S){oa=v.getCurrentTime();R=Zl().getTime();ca.Vc();T=S;V();W()}}}function k(v){for(var w=v.split(","),y=w.length,x=[],A=0;A<y;A++){var z=parseInt(w[A],10);isNaN(z)||100<z||0>z||x.push(z/100)}x.sort(function(B,E){return B-E});return x}function l(v){for(var w=v.split(","),y=w.length,x=[],A=0;A<y;A++){var z=parseInt(w[A],10);isNaN(z)||0>z||x.push(z)}x.sort(function(B,E){return B-E});return x}function n(v,w,y){var x=v.map(function(B){return{Ha:B,
Ze:B,Ve:void 0}});if(!w.length)return x;var A=w.map(function(B){return{Ha:B*y,Ze:void 0,Ve:B}});if(!x.length)return A;var z=x.concat(A);z.sort(function(B,E){return B.Ha-E.Ha});return z}function p(v){var w=!!v.vtp_captureStart,y=!!v.vtp_captureComplete,x=!!v.vtp_capturePause,A=k(v.vtp_progressThresholdsPercent+""),z=l(v.vtp_progressThresholdsTimeInSeconds+""),B=!!v.vtp_fixMissingApi;if(w||y||x||A.length||z.length){var E={Gg:w,Eg:y,Fg:x,Ch:A,Dh:z,Oe:B,Dd:void 0===v.vtp_uniqueTriggerId?"":v.vtp_uniqueTriggerId},
G=X("YT"),M=function(){f(E)};I(v.vtp_gtmOnSuccess);if(G)G.ready&&G.ready(M);else{var O=X("onYouTubeIframeAPIReady");em("onYouTubeIframeAPIReady",function(){O&&O();M()});I(function(){for(var V=X("document"),W=V.getElementsByTagName("script"),ca=W.length,J=0;J<ca;J++){var K=W[J].getAttribute("src");if(b(K,"iframe_api")||b(K,"player_api"))return}for(var P=V.getElementsByTagName("iframe"),U=P.length,T=0;T<U;T++)if(!u&&d(P[T],E.Oe)){N("https://www.youtube.com/iframe_api");u=!0;break}})}}else I(v.vtp_gtmOnSuccess)}
var r=["www.youtube.com","www.youtube-nocookie.com"],t={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},q,u=!1;(function(v){Z.__ytl=v;Z.__ytl.b="ytl";Z.__ytl.g=!0;Z.__ytl.priorityOverride=0})(function(v){v.vtp_triggerStartOption?p(v):Zg(function(){p(v)})})}();
...
(function(a){var b=!0;b=!1;if(b){a();return}var c=function(){var h=F["google.tagmanager.debugui2.queue"];h||(h=[],F["google.tagmanager.debugui2.queue"]=h,Uc("https://www.googletagmanager.com/debug/bootstrap"));
return h},d="x"===Be(F.location,"query",!1,void 0,"gtm_debug");if(!d&&H.referrer){var e=De(H.referrer);d="tagassistant.google.com"===Ae(e,"host")}if(!d){var f=He("__TAG_ASSISTANT");d=f.length&&f[0].length}F.__TAG_ASSISTANT_API&&(d=!0);if(d&&Rc){c().push({messageType:"CONTAINER_STARTING",data:{scriptSource:Rc,resume:function(){a()}}});return}a()})(Wo);
